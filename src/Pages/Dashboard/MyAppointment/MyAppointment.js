...
const MyAppointment = () => {
    ...
    const url = `https://doctors-portal-server-authoi234s-projects.vercel.app/bookings?email=${user?.email}`;
                    ...
                    <tbody>
                        {
                            ...
                            bookings?.map((booking, i) => <tr className='hover' key={i}>
                                ...
                                <td>{booking.slot}</td>
                                <td>{booking.price && <p className='font-semibold'>${booking.price}</p>}</td>
                                <td>
                                    {
